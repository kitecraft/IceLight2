...
#define ICELED_RAND16_2053  ((uint16_t)(2053))
#define ICELED_RAND16_13849 ((uint16_t)(13849))

#define APPLY_ICELED_RAND16_2053(x) (x * ICELED_RAND16_2053)
...
{
    rand16seed = APPLY_ICELED_RAND16_2053(rand16seed) + ICELED_RAND16_13849;
